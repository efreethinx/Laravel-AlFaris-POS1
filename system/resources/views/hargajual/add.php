    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                    {!! Form::text('kontak_id', old('kontak_id'), ['class' => 'form-control', 'placeholder' => '', 'readonly' => 'true', 'style'=>'background: #eee']) !!}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                    {!! Form::text('kode_kontak', old('kode_kontak'), ['class' => 'form-control', 'placeholder' => '', 'readonly' => 'true', 'style'=>'background: #eee']) !!}
                    </div>
                    <p class="help-block"></p>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    {!! Form::text('harga_jual', old('harga_jual'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                    <p class="help-block"></p>
...
<div class="btn-group pull-right">
            <a href="{{URL('hargajual')}}" class="btn btn-primary"><i class="fa fa-chevron-left fa-fw"></i> Back</a>
