...
@section('content')
    ...
    {!! Form::model($hargajual, ['method' => 'PUT', 'route' => ['hargajual.update', $hargajual->id],'class' => 'form-horizontal']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                    {!! Form::text('kode_kontak', old('kontak_id'), ['class' => 'form-control', 'readonly' => 'true', 'style'=>'background: #eee']) !!}
                    </div>
                    <p class="help-block"></p>
         ...
         <div class="btn-group pull-right">
            <a href="{{url('kontak/hargajual/').'/'.$hargajual->kontak_id}}" class="btn btn-primary"><i class="fa fa-chevron-left fa-fw"></i> Back</a>
