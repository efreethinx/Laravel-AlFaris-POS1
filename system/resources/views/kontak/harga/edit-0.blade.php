...
@section('content')
    ...
    {!! Form::model($roleId, ['method' => 'PUT', 'route' => ['kontak.update', $kontak->id],'class' => 'form-horizontal']) !!}
...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">  
                ...
                {{ Form::hidden('kontak_id', old('kontak_id'), array('id'=>'kontak_id', 'class' => 'form-control')) }}
                {{ Form::text('nama_kontak', $kontak_list2->nama_kontak, array('class' => 'form-control', 'placeholder'=>'Nama Pelanggan')) }}
                ...
                <table class="table table-no-bordered table-responsive" id="item_table">
                    ...
                    <tbody style="background: #eee;" class="item_body">
                        ...
                        <tr class="item">
                            ...
                            <input type="text" name="kode_produk[{{ $i }}]" class="form-control input-sm kode_produk" id="kode_produk" value="{{$member->kode_produk}}" readonly="true">
                            </td>
                            <td width="25%">
                             <div class="input-group">
                             <input type="text" name="nama_produk[{{ $i }}]" class="form-control input-sm nama_produk" id="nama_produk"  value="{{ $member->nama_produk }}">
                             <span class="input-group-btn">
