      <!-- Modal -->
      <div class="modal fade" id="myModalKontak" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="myModalLabel">Daftar Nama Pelanggan</h4>
            </div>
            <div class="modal-body">
              ...
              <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="grid simple ">
                            ...
                            <div class="grid-body no-border">
                                  ...
                                  -->
                                    <table id="tabel_kontak" class="table display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th style="width:1%" hidden="true" >
                                                    &nbsp;
                                                </th>
                                                <th style="width:19%">Kode Kontak</th>
                  ...
                  <tr>
                    ...
                    <td class="v-align-middle">{{ $data->kode_kontak }}</td>
                    <td class="v-align-middle">{{ $data->nama_kontak }}</td>
