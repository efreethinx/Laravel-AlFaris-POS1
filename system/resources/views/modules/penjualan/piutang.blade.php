        ...
        <div class="panel-body table-responsive">             
              ...
              <div class="table-responsive">                    
                <table id="list" class="table table-bordered table-striped table-condensed">
                  <thead>
                    <tr>
                      <th class="text-left" width="20%">Pelanggan</th>
                      <th class="text-center" width="20%">Mata Uang</th>
                      <th class="text-right" width="20%">Debit</th>
                      <th class="text-right" width="20%">Piutang Terbayar</th>
                      <th class="text-right" width="20%">Saldo Piutang</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
