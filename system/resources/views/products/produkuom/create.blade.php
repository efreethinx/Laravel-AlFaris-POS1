    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    {!! Form::label('kontak_id', 'Produk ID *', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                    {!! Form::text('nama_produk', $kontak->nama_produk, ['class' => 'form-control', 'readonly' => 'true', 'style'=>'background: #eee']) !!}
                    </div>
                    <p class="help-block"></p>
